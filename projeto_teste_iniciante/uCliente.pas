...
begin
  ...
  begin
    ...
    begin
      aCliente[I].codigo := cliente.codigo;
      aCliente[I].nome := cliente.nome;
      aCliente[I].idade := cliente.idade;
      aCliente[I].cidade := cliente.cidade;
      aCliente[I].sobrenome := cliente.sobrenome;
      aCliente[I].sexo := cliente.sexo;
      aCliente[I].ativo := cliente.ativo;
      break;
    end;
